                    ...
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex">
                            <div class="user-name text-end me-3">
                                <h6 class="mb-0 text-gray-600">{{auth()->user()->nama_karyawan}}</h6>
                                <p class="mb-0 text-sm text-gray-600">Admin</p>
                            </div>
                            <div class="user-img d-flex align-items-center">
                                <div class="avatar avatar-md">
                                    @if(auth()->user()->foto_profil)
                                        <img src="{{ asset('uploads/profil/' . auth()->user()->foto_profil) }}" alt="Foto profil">
                                    @else
                                        <img src="{{ asset('assets') }}/images/user.png" alt="Foto profil">
                                    @endif
                                </div>
                            </div>
                        </div>
